...
#define G_SAMPLE_SEPARATION 100 // in milliseconds works
//#define G_SAMPLE_SEPARATION 1000 // in milliseconds doesn't work - large error even when still

#define X_SAMPLE_NUM 20
#define Y_SAMPLE_NUM 20 
#define Z_SAMPLE_NUM 20 
#define G_SAMPLE_NUM 20 //works
//#define G_SAMPLE_NUM 80 //doesn't work  - large error even when still
